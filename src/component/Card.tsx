...
export const ProductCard = ({
  ...
  return (
    <div className="border-2  text-center  flex flex-col gap-2 shadow-2xl justify-between">
      <div className="px-6 py-8 mx-auto">
        ...
        <p className="text-base text-gray-400 pb-3 ">{category}</p>
      ...
      <button className="bg-green-500 py-4 text-xl text-white">
        Add to Cart
      </button>
    </div>
  );
